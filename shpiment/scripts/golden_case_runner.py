...
TYPEB_PRIORITY = [
    ...
    ('Customs', ['customs clearance','bill of entry','boe','customs duty','export customs','import customs','shj customs code-opening','new code opening fee','customs gate pass','customs documentation','customs']),
